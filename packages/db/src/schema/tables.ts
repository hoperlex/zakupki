...
export const organizations = pgTable('organizations', {
  ...
  counterpartyType: counterpartyTypeEnum('counterparty_type').notNull().default('supplier'),
  isGeneralContractor: boolean('is_general_contractor').notNull().default(false),
